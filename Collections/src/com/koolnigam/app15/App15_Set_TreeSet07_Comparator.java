...
class Employee implements Comparable {
   ...
   public int compareTo(Object obj)  // Sorting based on eid from ascending order
   {
     int eid1 = this.eid;
...
class MyComparator implements Comparator {
	 ...
	 public int compare(Object obj1, Object obj2) {
         ...
         String s1 = e1.name;
         String s2 = e2.name;
         return s1.compareTo(s2);  // Sorting based on ename based on ascending order
    }
}
public class App15_Set_TreeSet07_Comparator {
