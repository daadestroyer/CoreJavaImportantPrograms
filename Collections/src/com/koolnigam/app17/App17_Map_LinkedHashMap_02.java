...
LinkedHashMap:-
========
>>> The underlying DS is HashTable and LinkedList
>>> Duplicate keys not allowed but values can be
>>> insertion order preserved and it based on hashCode of keys
...
2. LHS LHS = new LHS(int initial capacity);
3. LHS LHS = new LHS(int initial capacity , float fill ratio)
4. LHS LHS = new LHS(Map m);
*/

public class App17_Map_LinkedHashMap_02 {
